...
public class TypeConverters {
    ...
    /** Convert an {@link info.nightscout.androidaps.diabeatit.assistant.alert.Alert.Urgency} into
    ...
    /** Convert an {@link Integer} representing the ordinal of an {@link info.nightscout.androidaps.diabeatit.assistant.alert.Alert.Urgency}
     * into the {@link info.nightscout.androidaps.diabeatit.assistant.alert.Alert.Urgency} object
     *
     * @param value     An {@link Integer} representing the ordinal of an {@link info.nightscout.androidaps.diabeatit.assistant.alert.Alert.Urgency}
     *                  value
     * @return          An {@link info.nightscout.androidaps.diabeatit.assistant.alert.Alert.Urgency}
