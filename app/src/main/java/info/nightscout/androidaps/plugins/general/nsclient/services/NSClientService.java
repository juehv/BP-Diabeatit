...
public class NSClientService extends Service {
    ...
    private Emitter.Listener onAnnouncement = new Emitter.Listener() {
        ...
        "title":"Announcement",
        "message":"test",
        "plugin":{"name":"treatmentnotify","label_red":"Treatment Notifications","pluginType":"notification","enabled":true},
        "group":"Announcement",
        "isAnnouncement":true,
    ...
    private Emitter.Listener onAlarm = new Emitter.Listener() {
        ...
        "eventName":"high",
        "plugin":{"name":"simplealarms","label_red":"Simple Alarms","pluginType":"notification","enabled":true},
        "pushoverSound":"climb",
